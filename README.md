...
4. `docs/supabase-catalog-fix.sql` if the Log Study subject/topic list does not load
5. `docs/supabase-seed-subjects.sql` if `subjects` or `topics` are empty and policies already exist
